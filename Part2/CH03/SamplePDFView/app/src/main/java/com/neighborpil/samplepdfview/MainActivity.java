package com.neighborpil.samplepdfview;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onButton1Clicked(View v){
        ...
        if(filename.length() > 0){
            ...
            Toast.makeText(getApplicationContext(), "PDF 파일명을 입력하셍", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void openPDF(String filename){
        ...
        if(file.exists()){
            ...
            try{
                ...
                Toast.makeText(getApplicationContext(), "PDF 파일을 보기 위한 뷰어 앱이 없습니다.",
